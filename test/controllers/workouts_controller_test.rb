...
class WorkoutsControllerTest < ActionController::TestCase
  ...
  test "should create workout" do
    assert_difference('Workout.count') do
      post :create, workout: { cardio: @workout.cardio, date: @workout.date, name: @workout.name, time: @workout.time }
    end
  ...
  test "should update workout" do
    patch :update, id: @workout, workout: { cardio: @workout.cardio, date: @workout.date, name: @workout.name, time: @workout.time }
    assert_redirected_to workout_path(assigns(:workout))
  end
